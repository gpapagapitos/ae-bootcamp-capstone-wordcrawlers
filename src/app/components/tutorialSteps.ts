...
export const TUTORIAL_STEPS: TutorialStep[] = [
  ...
  },
  {
    ...
    body: "Choose Splay Left or Splay Right before casting. It decides which end of your word becomes the top card and which edge values (hits/blocks/energy) count.",
  ...
  },
  {
    ...
    body: "This enemy has a weak-spot vowel you can play. Making it your word's top card advances the enemy's next intent immediately.",
