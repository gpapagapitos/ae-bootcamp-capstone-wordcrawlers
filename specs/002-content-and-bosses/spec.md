...
5. No enemy, boss or otherwise, tracks or penalizes repeated words (spec 009 R11).
2. Bosses require strategy changes between phase 1 and phase 2.
3. At least 3 deck archetypes can defeat a full MVP run.
4. Shop and reward choices produce non-trivial decisions in most encounters.
